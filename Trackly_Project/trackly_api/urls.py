...
from .views import ReviewList, SingleReview, CreateUserView, BlackListTokenView, CreateAlbumView, CreateArtistView, \
    ...
    CommentList, RandomAlbums, FavouriteList, AlbumFavouriteList, DeleteFavourite, RecentReviewsAPIView, DeleteCommentView
...
urlpatterns = [
    ...
    path('albums', RandomAlbums.as_view(), name='randomAlbum'),
